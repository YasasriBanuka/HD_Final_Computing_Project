...
<html lang="en">
<?php
// Include database connection and product action files
...
// Function to display alert and redirect to 'your_orders.php'
...
if (empty($_SESSION["user_id"])) {
    ...
    foreach ($_SESSION["cart_item"] as $item) {
        ...
        if (isset($_POST['submit'])) {
            ...
            // Clear cart session and reset item data
            unset($_SESSION["cart_item"]);
            unset($item["title"]);
            unset($item["quantity"]);
            unset($item["price"]);

            // Set success message and call alert function
    ...
    <div class="site-wrapper">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/icon1.png" alt=""></a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            if (empty($_SESSION["user_id"])) {
                                ...
                                // Display order and logout links if user is logged in
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
                ...
                <span style="color:green;"><?php echo isset($success) ? $success : ''; ?></span>
            </div>
