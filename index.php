    ...
    <style>
        * {
        ...
        .bg-white {
            ...
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.3); /* Uniform shadow for all sides */
...
<body class="home">
    ...
    <div class="image-slideshow">
        ...
        <div class="image fade">
            <img src="images/img/back3.jpg" alt="  ">
        </div>
        <div class="image fade">
            <img src="images/img/food33.png" alt=" ">
        </div>
    </div>
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                <div class="food-item-wrap">
                                    <div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/' . $r['img'] . '"></div>
                                     ...
                                     <span class="price">Rs. ' . $r['price'] . '</span> <a href="dishes.php?res_id=' . $r['rs_id'] . '
                                " class="btn theme-btn-dash pull-right">Order Now</a> </div>
                             </div> 
                         </div>
                    </div>';
                  }
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We've got your covered with menus from our restaurants online.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a dish</h3>
                            <p>We"ve got your covered with a variety of foods online.</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded shadow p-4">
                <div class="d-flex justify-content-center align-items-center mb-2"> 
                    <iframe class="w-100 rounded" height="320px" 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3967.4838624307636!2d80.23275667354342!3d6.065290128321443!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae171053c421fd7%3A0x4f930c4e759bf84c!2sLeon&#39;s%20Kitchen!5e0!3m2!1sen!2slk!4v1727770029439!5m2!1sen!2slk" 
                        width="600" height="450" style="border:0;"
                        allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                    </iframe>
                </div>
                <div class="mt-3 text-center">
                    <h5>Leon's Kitchen</h5>
                    <p>Leon's Kitchen is a cozy and welcoming restaurant offering a diverse menu of delicious dishes made from fresh, locally sourced ingredients. Enjoy a warm ambiance and friendly service while indulging in our signature meals.</p>
                </div>
            </div>
        </div>
       <!-- Feedback Form Column with space -->
    <div class="col-lg-5 mb-5 px-4 ms-4"> <!-- Added ms-4 for space -->
        <div class="bg-white rounded shadow p-4">
