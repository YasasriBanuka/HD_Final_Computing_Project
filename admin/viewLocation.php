            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">View all Restaurent Locations</h4>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Listed Locations</h4>

                                <!-- Search form to filter categories -->
                                <form action="" method="POST" class="form-inline">
                                    <input type="text" name="search" class="form-control" placeholder="Search by category name" required>
                                    ...
                                    <table id="myTable" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search_btn'])) {
                                                $search = $_POST['search'];
                                                // Query to search categories by name
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                // Display each category in the table
